...
const CreateDao = (props: {handleSubmitCreate:any}) => {
    ...
    const {daoName,
        ...
        setCategories,
        description,
        setDescription} = useContext(CreateDaoContext);
      ...
      <div className="bg-welcome pt-28  min-h-[100vh] w-full px-5 md:px-60">
        ...
        <form onSubmit={handleSubmit}>
          <div className="pl-32 py-4 pr-80">
            ...
            <Input value={daoName} name="dao_name" type="text" handleChange={(e:any) => setDaoName(e.target.value)} />
  
            <label className="block pt-4 text-slate-400 text-sm font-normal" htmlFor="daoLogo">
              DAO Logo
            </label>
            <FileUploader
            ...
            <MultiSelect handleChange={handleCategoriesChange} listItems={daoCategoryItems} name={'daoCategories'}/>
