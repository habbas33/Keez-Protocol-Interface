...
const CreateMasterKey = (props: {handleSubmitCreate:any}) => {
    ...
    function handleSubmit(event: any) {
        ...
        console.log("Create masterkey",{'keyTitle':keyTitle,'categories':categories,'description':description});
      ...
      <div className="bg-welcome pt-28  min-h-[100vh] w-full px-5 md:px-60">
        ...
        <form onSubmit={handleSubmit}>
          <div className="pl-32 py-4 pr-80">
            ...
            <Input placeholder="" name="key_title" type="text" handleChange={(e:any) => setKeyTitle(e.target.value)} />
            ...
            <textarea className="my-1 h-28 w-full rounded-sm p-2 outline-none text-white border-2 border-[#999999] focus:border-red-400 text-sm text-gray-700 leading-tight" placeholder="" name="description" onChange={(e:any) => setDescription(e.target.value)}/>
