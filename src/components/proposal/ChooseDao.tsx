            ...
            {memberDaos.length!=[] ? (
              <div className="flex flex-wrap py-3">
                    {[...memberDaos].reverse().map((daoDetail, i) => (
                          <DaoCard key={i} id={i} daoSelected={daoSelected} handleDaoSelection={handleDaoSelection} daoDetail={daoDetail}/>
                      ))}
              </div>
              ) : (
              <div className="flex flex-wrap py-3">
...
const DaoCard = (props:{id:number, daoSelected:number, handleDaoSelection:any, daoDetail:any} ) => {
