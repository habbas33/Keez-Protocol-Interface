...
const GeneralTemplate = (props: {handleComponent:any}) => {
    ...
    const formSubmitValidations = () => {
        ...
        let result;
        votingOptions.forEach((item) => item===""? result = "empty": result = "pass");
    ...
    const handleRemoveOption = (id: number) => {
      ...
      var filtered = votingOptions.filter(function(value:any, index:any, arr:any){ 
        ...
        <form onSubmit={(event) => handleSubmit(event)}>
            ...
            <div className="flex flex-col justify-center items-center py-2 px-32">
              <div className= " w-1/2">
                ...
                <label className="block pt-4 text-slate-400 text-sm font-semibold" htmlFor="votinOptions">
                  Voting Options
                </label>
