      ...
      <form onSubmit={(event) => handleSubmit(event)}>
        ...
        <div className="flex flex-col justify-center items-center py-2">
          <div className=" w-full md:w-1/2">
            ...
            <div
              onChange={onChangeMembersOrVault}
              className="flex justify-between items-center"
            >
              <div className="flex justify-start items-center w-1/2">
                <input
                  checked={membersOrVault === "Members"}
                  type="radio"
                  value="Members"
                  name="membersOrVault"
                ...
                <label
                  htmlFor="Members"
                  className="block text-white text-sm px-2 font-normal"
                >
                  Dao Members
                </label>
              </div>
            ...
            <div
              onChange={onChangeAddOrRevoke}
              className="flex justify-between items-center"
            >
              <div className="flex justify-start items-center w-1/2">
                <input
                  checked={addOrRevoke === "Add"}
                  type="radio"
                  value="Add"
                  name="addOrRevoke"
                  className="accent-[#C3073F] focus:accent-[#ac0537]"
            ...
            <SingleSelect
              handleChange={() => console.log("handleSelectAddress")}
              name={"address"}
              listItems={[]}
            />
                ...
                <div className="grid gap-x-4 gap-y-0 grid-cols-2 text-white">
                  <div className="flex items-center my-3">
                    <input
                      ...
                      name="masterKey"
                      onClick={(e: any) =>
                        setMasterKeyPermission(e.target.checked)
                      }
                      className="accent-[#C3073F] focus:accent-[#ac0537]"
                    />
                    <label
                  ...
                  <div className="flex items-center my-3">
                    <input
                      ...
                      name="propose"
                      onClick={(e: any) =>
                        setProposePermission(e.target.checked)
                      }
                      className="accent-[#C3073F] focus:accent-[#ac0537]"
                    />
                    <label
