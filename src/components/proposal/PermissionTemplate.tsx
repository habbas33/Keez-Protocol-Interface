                  ...
                  <div className="grid gap-x-4 gap-y-0 grid-cols-2 text-white">
                    ...
                    <div className="flex items-center my-3">
                        ...
                        <Switch
                          ...
                          onChange={(e:any) => setProposePermission(!proposePermission)}
                          name="propose"
                          inputProps={{ 'aria-label': 'secondary checkbox' }}
                        />
                    ...
                    <div className="flex items-center my-3">
                        ...
                        <Switch
                          ...
                          onChange={(e:any) => setSendDelegatePermission(!sendDelegatePermission)}
                    ...
                    <div className="flex items-center my-3">
                        ...
                        <Switch
                          ...
                          onChange={(e:any) => setReceiveDelegatePermission(!receiveDelegatePermission)}
