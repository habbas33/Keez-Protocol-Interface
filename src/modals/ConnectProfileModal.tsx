              ...
              <div className="bg-inherent">
                <div className="sm:flex sm:items-start">
                  <div className="mt-3 text-center  sm:mt-0 sm:ml-0 sm:text-left">
                    <div className="px-6 py-5 bg-[#4E4E50] flex justify-between items-center">
                      <Dialog.Title as="h3" className="text-xl leading-6 font-medium text-white">
                        Connect your Universal Profile
                      </Dialog.Title>
                      <AiOutlineClose fontSize={24} className="text-white hover:bg-[#59595c] p-[2px] rounded-full cursor-pointer" onClick={() => setOpen(false)}/>
                    </div>
                    <div className="py-4 px-6 font-light bg-[#59595c]">
