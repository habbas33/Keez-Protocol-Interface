...
import { getVotesBySignature } from "../services/keezBackend";
...
export default function ProposalVotingModal(props: {
  ...
  const handleRegister = async () => {
    ...
    try {
      ...
      const result = await registerVotes(
        contractAddressObject,
        proposalSignature,
        signaturesArray,
        addressesArray,
            ...
            >
              <div className="flex flex-col justify-between items-center p-8 bg-[#8168ff]">
                <div className="flex flex-row w-full justify-between items-center">
                  ...
                  <AiOutlineClose
                    fontSize={24}
                    className="text-white hover:bg-[#8186ff] p-[2px] rounded-full cursor-pointer"
                    onClick={handleModel}
                  />
                </div>
                ...
                <div className="grid gap-x-6 gap-y-0 md:grid-cols-2 grid-cols-1 w-full text-white py-2">
                  <div className="flex flex-col space-y-2 justify-start items-start">
                    <h1 className="w-[100%] text-white text-md font-semibold break-words">
                    ...
                    <div className="flex flex-col w-full h-full justify-between items-start ">
                      <div className="max-h-[200px] min-h-[200px] w-[100%] overflow-auto pb-3 ">
                        <h1 className="text-white  text-xs font-normal break-words">
                    ...
                    <div className="flex flex-col justify-start items-start">
                      {(proposalStatus === "Active" ||
                        ...
                        <>
                          ...
                          <ProgressBar
                            reject={(totalRejected / voters.length) * 100}
                            approve={(totalApproved / voters.length) * 100}
                            abstain={(totalAbstained / voters.length) * 100}
                          />
                          <div className="flex justify-start items-center">
                    ...
                    <div className="flex flex-col w-full text-center space-y-1 justify-center items-center text-center">
                      {hasVoted && (
                        <>
                          ...
                          <div
                            className={`flex justify-start items-center w-28 cursor-default ${
                              voterChoice === 1
    ...
    <div className="flex flex-col justify-start items-start">
      ...
      <div className="flex justify-start items-center">
        ...
        <h1 className="text-xs font-semibold px-2">
          {proposalDetailsObject.keyPermissions.keyPermissions.vote === "True"
            ? "true"
            : "false"}
        </h1>
      </div>
      ...
      <div className="flex justify-start items-center">
        ...
        <h1 className="text-xs font-semibold px-2">
          {proposalDetailsObject.keyPermissions.keyPermissions
  ...
  return (
    <div className="my-1 w-full">
      <div className={`flex justify-start items-center text-black`}>
        <span className="text-green-700 drop-shadow-md text-xs font-bold pr-1">
          {`${approve.toFixed(2)}%`} approved,
        </span>
        <span className="text-red-700 drop-shadow-md text-xs font-bold pr-1">
          {`${reject.toFixed(2)}%`} rejected,
        </span>
        <span className="text-yellow-500 drop-shadow-md text-xs font-bold">
          {`${abstain.toFixed(2)}%`} abstained
        </span>
      </div>
      <div className="flex h-3 w-[100%] bg-gray-200 rounded-lg my-1 border-2 border-solid border-blue-600 drop-shadow-md">
        <div
          style={{
            width: widthApprove,
            background:
              "repeating-linear-gradient(45deg,#15803D 0px,#15803D 10px, #60ad7d 10px, #60ad7d 20px)",
          }}
        ...
        <div
          style={{
            width: widthReject,
            background:
              "repeating-linear-gradient(45deg,#B91C1C 0px,#B91C1C 10px, #b85f5f 10px, #b85f5f 20px)",
          }}
        ...
        <div
          style={{
            width: widthAbstain,
            background:
              "repeating-linear-gradient(45deg,#EAB308 0px,#EAB308 10px, #c2c071 10px, #c2c071 20px)",
          }}
